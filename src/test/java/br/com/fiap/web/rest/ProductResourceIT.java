...
class ProductResourceIT {
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product().productName(DEFAULT_PRODUCT_NAME).weight(DEFAULT_WEIGHT);
        // Add required entity
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product().productName(UPDATED_PRODUCT_NAME).weight(UPDATED_WEIGHT);
        // Add required entity
        ProductCategory productCategory;
        if (TestUtil.findAll(em, ProductCategory.class).isEmpty()) {
    ...
    void putNewProduct() throws Exception {
        ...
        updatedProduct.productName(UPDATED_PRODUCT_NAME).weight(UPDATED_WEIGHT);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.productName(UPDATED_PRODUCT_NAME).weight(UPDATED_WEIGHT);
